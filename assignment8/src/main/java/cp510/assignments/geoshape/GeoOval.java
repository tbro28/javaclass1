 ...
 * @author Tim
 */
public class GeoOval extends cp510.assignments.geoshape.GeoRectangle {
     ...
     * @param height
     */
    public GeoOval(cp510.assignments.geoshape.GeoPoint origin, double width, double height) {
     ...
     */
    public GeoOval(cp510.assignments.geoshape.GeoPoint origin, Color color,
