...
public class GeoShapeDriverV1
{
    ...
    {
        cp510.assignments.geoshape.GeoPoint point1  = new cp510.assignments.geoshape.GeoPoint();
        point1.setXco( 5.55555 );;
        point1.setYco( 4.44444 );

        cp510.assignments.geoshape.GeoPoint point2  = new cp510.assignments.geoshape.GeoPoint();
        point2.setXco( 54.66666 );
        point2.setYco( 133.33333 );

        cp510.assignments.geoshape.GeoPoint point3  = new cp510.assignments.geoshape.GeoPoint();
        point3.setXco( 200 );
        point3.setYco( 400 );

        cp510.assignments.geoshape.GeoPoint point4  = new cp510.assignments.geoshape.GeoPoint();
        point4.setXco( 1000 );
        point4.setYco( 2000 );
...
//        point1.str();
        ...
        cp510.assignments.geoshape.GeoPoint point5  = new cp510.assignments.geoshape.GeoPoint();
...
*/
        ...
        cp510.assignments.geoshape.GeoPoint start = new cp510.assignments.geoshape.GeoPoint(1,1);
        cp510.assignments.geoshape.GeoPoint end = new cp510.assignments.geoshape.GeoPoint(5, 5);
